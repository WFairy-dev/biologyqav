...
from chat.server.db.base import Base, engine
from chat.server.db.models.conversation_model import ConversationModel
from chat.server.db.models.message_model import MessageModel
from chat.server.db.repository.knowledge_file_repository import (
    add_file_to_db,
)


from chat.server.db.repository.knowledge_metadata_repository import (
    add_summary_to_db,
)
from chat.server.db.session import session_scope
from chat.server.knowledge_base.kb_service.base import (
    KBServiceFactory,
    SupportedVSType,
)
...
from chat.server.utils import get_default_embedding
