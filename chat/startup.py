...
def dump_server_info(after_start=False, args=None):
    ...
    print("\n")
    print("=" * 30 + "Biology Chat Configuration" + "=" * 30)
    print(f"操作系统：{platform.platform()}.")
    print(f"python版本：{sys.version}")
    print(f"项目版本：{__init__.__version__}")
    ...
    if after_start:
        ...
        print(f"服务端运行信息：")
        if args.api:
            print(f"    Biology Chat Api Server: {api_address()}")
        if args.webui:
            print(f"    Biology Chat WEBUI Server: {webui_address()}")
    print("=" * 30 + "Biology Chat Configuration" + "=" * 30)
    print("\n")
